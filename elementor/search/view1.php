...
$search_category_placeholder = $category_field_ph ? $category_field_ph : get_directorist_option( 'search_category_placeholder', esc_html__( 'Select a category', 'direo-core' ) );
$search_location_placeholder = $location_field_ph ? $location_field_ph : get_directorist_option( 'search_location_placeholder', esc_html__( 'Select a location', 'direo-core' ) );
$search_listing_text         = $search_btn_ph ? $search_btn_ph : get_directorist_option( 'search_listing_text', esc_html__( 'Search', 'direo-core' ) );
