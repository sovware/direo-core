...
function direo_custom_style() {
	...
	<style>
		...
		.atbd_map_shape:before, .atbd_map_shape:before, .woocommerce .woocommerce-info, .atbdp_listings_map_page_loading:after {
		...
		<?php if ( '#3a7dfd' != $info ) { ?>
		/* Colors: Info */
		.color-info, .post-pagination .prev-post p a, .post-pagination .next-post p a, .woocommerce .woocommerce-info:before, .iborder-info, .outline-info, .circle-info, .outline-lg-info, #directorist.dashboard_area .tab-content .db_btn_area .directory_edit_btn, .atbdp_listing_top_category .color-4 span, #directorist.atbd_wrapper .directory_home_category_area .atbdp_listing_top_category li a.color-4 span, #directorist.atbd_wrapper .directory_home_category_area ul.categories li a span.color-4 {
		...
		/* Gradient BG */
		.bg-gradient-ps, .atbdp_float_active {
		...
		.bg-gradient-pw, .pricing.pricing--1.atbd_pricing_special .atbd_popular_badge {
			...
			background: linear-gradient(to right, <?php echo esc_attr( $primary ); ?>, <?php echo esc_attr( $warnning ); ?>);
		...
		.btn-gradient.btn-gradient-two:before {
			...
			background: linear-gradient(to right, <?php echo esc_attr( $warnning ); ?>, <?php echo esc_attr( $primary ); ?>);
		}
