...
class DireoDemo_Importer {
	...
	public function __construct() {
		...
		add_filter(
			...
			function ( $links ) {
				$mylinks = array(
					'<a href="' . esc_url( admin_url( 'tools.php?page=fw-backups-demo-content' ) ) . '">' . __( 'Install Demo Contents', 'direo-core' ) . '</a>',
				);
		...
		add_filter(
			...
			function () {
				$text = esc_html__( 'IMPORTANT: Installing this demo will delete all existing data and contents of your website, so use it only in fresh website. Do you want to continue?', 'direo-core' );
				return $text;
			}
		);
		...
		add_filter(
			...
			function () {
				...
				$html .= __( 'Warning: All your old data will be lost if you install demo data from here, so please use it only in new website.', 'direo-core' );
				$html .= '</div>';
				return $html;
			}
		);
	...
	public function demo_importer_config( $demos ) {
		$demos_array = array(
			'demo1' => array(
				'title'        => __( 'Home Static', 'direo-core' ),
				'screenshot'   => 'https://demo.directorist.com/theme/demo-content/direo/direo.jpg',
				'preview_link' => 'https://demo.directorist.com/theme/direo/',
			),
		);

		$remote_server_url = 'https://demo.directorist.com/theme/demo-content/direo';
...
function direo_import_files() {
	 return array(
		 array(
			 ...
			 'import_file_url'            => 'https://demo.directorist.com/theme/demo-content/direo/content.xml',
			 'import_widget_file_url'     => 'https://demo.directorist.com/theme/demo-content/direo/widgets.wie',
			 'import_customizer_file_url' => 'https://demo.directorist.com/theme/demo-content/direo/customizer.dat',
