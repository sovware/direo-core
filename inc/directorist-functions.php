...
function direo_package_tab() {
	...
	return sprintf( '<li class="%s"><a %s ><i class="la la-money-bill"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Packages', 'direo-core' ) );
}

add_filter( 'atbdp_package_tab', 'direo_package_tab' );
	...
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'Packages', 'direo-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'direo-extension' ); ?></a>
						</li>
						<li class="breadcrumb-item active" aria-current="page">
							<?php echo esc_html__( 'Packages', 'direo-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
function direo_after_package_table() {
	echo wp_kses_post( '</div></main>' );
}

add_action( 'atbdp_after_package_table', 'direo_after_package_table' );


/*
Order History==========*/
// Order tap trigger.
function direo_order_history_tab() {
	...
	return sprintf( '<li class="%s"><a %s ><i class="la la-history"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Order History', 'direo-core' ) );
}

add_filter( 'atbdp_order_history_tab', 'direo_order_history_tab' );
...
function direo_before_order_table() {
	...
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'Order History', 'direo-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'direo-extension' ); ?></a>
						...
						<li class="breadcrumb-item active" aria-current="page">
						<?php echo esc_html__( 'Order History', 'direo-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
function direo_after_order_table() {
	echo wp_kses_post( '</div></main>' );
}

add_action( 'atbdp_after_order_table', 'direo_after_order_table' );
...
function announcement_user_dashboard_tab( $html, $count ) {
	...
	return sprintf( '<li class="%s"><a %s ><i class="las la-bullhorn"></i><span> %s </span>%s</a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Announcement', 'direo-core' ), $nav_label );
}

add_filter( 'announcement_user_dashboard_tab', 'announcement_user_dashboard_tab', 10, 2 );

// Announcement content wrapping attributes.
function direo_live_announcement_tab_content_class( $attr ) {
	return wp_kses_post( 'class="tab-pane fade" id="active-announcement" role="tabpanel" aria-labelledby="v-pills-announcement-tab"' );
}

add_filter( 'announcement_dashboard_content_div_attributes', 'direo_live_announcement_tab_content_class' );
...
function announcement_dashboard_before_content() {
	...
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'announcement', 'direo-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'direo-extension' ); ?></a>
						...
						<li class="breadcrumb-item active" aria-current="page">
							<?php echo esc_html__( 'announcement History', 'direo-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
/*
===========Chat History==========*/
// Chat tab wrapping attributes.
function direo_user_dashboard_tab() {
	$attr = 'id="v-pills-chat-tab" data-toggle="pill" href="#active-chat" role="tab" aria-controls="active-chat" aria-selected="false"';
	return sprintf( '<li class="%s"><a %s ><i class="las la-comments"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Chat', 'direo-core' ) );
}

add_filter( 'dlc_user_dashboard_tab', 'direo_user_dashboard_tab' );

// Chat content wrapping attributes.
function direo_live_chat_tab_content_class( $attr ) {
	return wp_kses_post( 'class="tab-pane fade" id="active-chat" role="tabpanel" aria-labelledby="v-pills-chat-tab"' );
}

add_filter( 'dlc_dashboard_content_div_attributes', 'direo_live_chat_tab_content_class' );

// Chat content wrapper and breadcrumb.
function direo_dashboard_before_content() {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'Chat', 'direo-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'direo-extension' ); ?></a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo esc_html__( 'Chat History', 'direo-extension' ); ?></li>
					</ol>
				</nav>
			</div>
	<?php
...
add_action( 'dlc_dashboard_before_content', 'direo_dashboard_before_content' );

// Chat content wrapper closing.
function direo_dashboard_after_content() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'dlc_dashboard_after_content', 'direo_dashboard_after_content' );

/*
My Booking==========*/
// Booking tab.
function direo_my_booking_tab() {
	return sprintf( '<li class="sidebar-dropdown"><a id="b-pills-booking-tab" data-toggle="pill" href="#active-my-booking" role="tab" aria-controls="active-my-booking" aria-selected="false"><i class="lar la-calendar-check"></i><span>%s</span></a></li>', __( 'My Bookings', 'direo-core' ) );
}

add_filter( 'atbdp_user_dashboard_booking_tab', 'direo_my_booking_tab' );

// Booking content wrapper.
function direo_my_booking_content() {
	return wp_kses_post( '<div class="tab-pane fade" id="active-my-booking" role="tabpanel" aria-labelledby="b-pills-booking-tab">' );
}

add_filter( 'atbdp_user_dashboard_booking_content_wrapper', 'direo_my_booking_content' );

// My Booking content wrapper and breadcrumb.
function direo_user_dashboard_booking_before_content( $args = '' ) {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
...
add_action( 'atbdp_user_dashboard_booking_before_content', 'direo_user_dashboard_booking_before_content' );

// My Booking content wrapper closing.
function direo_user_dashboard_booking_after_content() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'atbdp_user_dashboard_booking_after_content', 'direo_user_dashboard_booking_after_content' );

/*
==========All Booking==========*/
// All Booking tab.
function direo_all_booking_tab() {
	?>
	<li class="sidebar-dropdown dashboard_booking">
		<a href="#approved-booking" class="sidebar-dropdown-icon">
			<i class="las la-clipboard-list"></i><span><?php esc_html_e( 'All Bookings', 'direo-core' ); ?></span>
		</a>
		<div class="sidebar-submenu">
			<ul class="nav flex-column">
				<li>
					<a class="direo_dash_submenu" id="ab-pills-active-tab" data-toggle="pill" href="#approved-booking" role="tab" aria-controls="approved-booking" aria-selected="true">
						<?php esc_html_e( 'Approved', 'direo-core' ); ?>
						<!--<span class="badge badge-pill badge-success">01</span>-->
					</a>
				</li>
				<li>
					<a id="ab-pills-pending-tab" class="direo_dash_submenu" data-toggle="pill" href="#pending-booking" role="tab" aria-controls="pending-booking" aria-selected="false">
						<?php esc_html_e( 'Pending', 'direo-core' ); ?>
						<!--<span class="badge badge-pill badge-warning">01</span>-->
					</a>
				</li>
				<li>
					<a id="ab-pills-cancelled-tab" class="direo_dash_submenu" data-toggle="pill" href="#cancelled-booking" role="tab" aria-controls="cancelled-booking" aria-selected="false">
						<?php esc_html_e( 'Cancelled', 'direo-core' ); ?>
...
add_filter( 'atbdp_user_dashboard_all_bookings_tab', 'direo_all_booking_tab' );

// Booking approved content wrapper
function direo_all_booking_approved() {
	return wp_kses_post( '<div class="tab-pane fade" id="approved-booking" role="tabpanel" aria-labelledby="ab-pills-active-tab">' );
}

add_filter( 'atbdp_user_dashboard_approved_bookings_content_wrapper', 'direo_all_booking_approved' );

// Booking pending content wrapper
function direo_all_booking_pending() {
	return wp_kses_post( '<div class="tab-pane fade" id="pending-booking" role="tabpanel" aria-labelledby="ab-pills-pending-tab">' );
}

add_filter( 'atbdp_user_dashboard_pending_bookings_content_wrapper', 'direo_all_booking_pending' );

// Booking cancelled content wrapper
function direo_all_booking_cancelled() {
	return wp_kses_post( '<div class="tab-pane fade" id="cancelled-booking" role="tabpanel" aria-labelledby="ab-pills-cancelled-tab">' );
}

add_filter( 'atbdp_user_dashboard_cancelled_bookings_content_wrapper', 'direo_all_booking_cancelled' );

function direo_booking_confirmation_title() {
	return __( 'Contact Information', 'direo-core' );
}
add_filter( 'booking_confirmation_title', 'direo_booking_confirmation_title' );
...
function wallet_user_dashboard_tab() {
	...
	return sprintf( '<li class="%s"><a %s ><i class="las la-wallet"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'wallet', 'direo-core' ) );
}

add_filter( 'atbdp_user_dashboard_wallet_tab', 'wallet_user_dashboard_tab' );

// wallet content wrapping attributes.
function direo_wallet_tab_content_class( $attr ) {
	return wp_kses_post( 'class="tab-pane fade" id="active-wallet" role="tabpanel" aria-labelledby="v-pills-wallet-tab"' );
}

add_filter( 'wallet_dashboard_content_div_attributes', 'direo_wallet_tab_content_class' );
...
function wallet_dashboard_before_content() {
	...
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'wallet', 'direo-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'direo-extension' ); ?></a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo esc_html__( 'wallet History', 'direo-extension' ); ?></li>
					</ol>
				</nav>
			</div>
	<?php
...
function direo_update_user_profile() {
	...
	if ( valid_js_nonce() ) {
		...
		if ( $success ) {
			wp_send_json_success( array( 'message' => esc_html__( 'Profile updated successfully', 'direo-core' ) ) );
		} else {
			wp_send_json_error( array( 'message' => esc_html__( 'Ops! something went wrong. Try again.', 'direo-core' ) ) );
		};
	}
	wp_die();
}

add_action( 'wp_ajax_direo_update_user_profile', 'direo_update_user_profile' );
...
function direo_added_class_before_listing_form() {
	echo sprintf( '<div class="%s">', 'col-lg-8 offset-lg-2' );
}
add_action( 'atbdb_before_add_listing_from_wrapper', 'direo_added_class_before_listing_form' );

/*added class before listing for wrapper*/
function direo_added_class_after_listing_form() {
	echo '</div>';
}
add_action( 'atbdb_after_add_listing_from_wrapper', 'direo_added_class_after_listing_form' );


// hboard Pagination for listing.
	...
	foreach ( $all_listings as $key => $post ) {
		...
		<td class="dl-title">
			<span class="atbd_footable">
				...
				$image_alt    = function_exists( 'direo_get_image_alt' ) ? direo_get_image_alt( $listing_prv_img ) : '';
		...
		<?php } ?>
		<td class="dl-expired">
			<?php echo esc_attr( $exp_text ); ?>
		</td>

		<td class="dl-status">
			<span class="badge badge-light active"><?php echo esc_html__( 'Active', 'direo-core' ); ?></span>
		</td>
		...
		<td class="edit_btn_wrap dl-action">
			...
			<div class="action_button">
				...
				<a href="listing-del" id="direo_remove_listing" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_remove_btn text-danger">
		...
		<div class="responsive_dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				...
				<a href="#" id="direo_remove_listing" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_remove_btn btn text-danger">
					<?php esc_html_e( 'Delete', 'direo-core' ); ?>
				</a>
			</div>
		</div>
...
// hboard Pagination for need listing .
...
function direo_user__dashboard_needs_pagination() {
	...
	for ( $i = $start_loop; $i <= $end_loop; $i++ ) {
		...
		// show dot if current page say 'i have some neighbors right form mine'
		if ( ( $cur_page > 4 ) ) {
			if ( ( $dot_ == $i ) ) {
				$jump           = $i + 5;
				$jump           = $jump > $no_of_paginations ? $no_of_paginations : $jump;
		...
		<tr data-expanded="<?php echo ( 0 === $key ) ? esc_html( 'true' ) : ''; ?>" class="listing_id_<?php echo esc_attr( $post->ID ); ?>">
			...
			<div class="responsive_dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					...
					<a href="#" id="direo_remove_listing" data-listing_id="<?php echo esc_attr( $post->ID ); ?>" class="directory_remove_btn btn btn-outline-danger">
						<?php esc_html_e( 'Delete', 'direo-core' ); ?>
					</a>
				</div>
			</div>
